...
import static main.ChessGame.virtualChessBoard;
...
public class Pawn extends ChessPiece {
    ...
    {
        Icon wpawn = new ImageIcon(getClass().getResource("../piecePic/wpawn.jpg"));
        this.setIcon(wpawn);
    }
    public void setBlackIcon()
    {
        Icon bpawn = new ImageIcon(getClass().getResource("../piecePic/bpawn.jpg"));
        this.setIcon(bpawn);
    }
